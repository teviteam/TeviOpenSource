...
1/ Download the Unity project. You can delete (or move) the “xx_Php_mysql” folder where the .php and .sql files are stored as they are not needed in Unity. Open the project.
...
If you need help, contact the devs:
